...
def image_object_detection(image_folder, csv_filename):
    weights_path = "D:/yolov5/runs/train/exp_food/weights/food.pt"
    ...
    with open(csv_filename, mode="w", newline="") as csv_file:
        ...
        for image_path in image_files:
            ...
            food_count = (results.pred[0][:, -1] == 0).sum().item()

            # 수정: weight_accuracy 정보 얻는 방식에 따라 변경해야 함
            # weight_accuracy = results.model.model[-1].float()  # 이전 방식
            weight_accuracy = ...  # 수정 필요

            writer.writerow({"Image": image_path, "Class": "food", "Count": food_count, "Weight_Accuracy": weight_accuracy})

            print(f"Processed {image_path}: Detected 'food' objects: {food_count}")
...
def main():
    # 이미지 객체 인식
    image_folder = "C:/Users/user/Desktop/yolov5/image/2.jpg"
    csv_filename = "C:/Users/user/Desktop/yolov5/food_result.csv"
